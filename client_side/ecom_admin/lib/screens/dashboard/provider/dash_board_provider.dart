...
class DashBoardProvider extends ChangeNotifier {
      ...
      for (int i = 0; i < imgXFiles.length; i++) {
        ...
        if (imgXFile != null) {
          ...
          if (kIsWeb) {
            ...
            formData['image${i + 1}'] = MultipartFile(
              byteImg,
              filename: fileName,
            ...
            formData['image${i + 1}'] = await MultipartFile(
              filePath,
              filename: fileName,
              contentType: mimeType,
            );
  ...
  setDataForUpdateProduct(Product? product) {
    // if (_dataProvider.categories.isEmpty ||
    //     _dataProvider.subCategories.isEmpty ||
    //     _dataProvider.brands.isEmpty ||
    //     _dataProvider.variantTypes.isEmpty ||
    //     _dataProvider.variants.isEmpty) {
    //   // Data not ready yet, skip or delay this call
    //   return;
    // }
